...
def plot_delivery_data(df):
    """
    Generate a scatter plot of the delivery data

    This function plot delivery time vs. distance, with markers colored by the
    time of the day and styled (filled/hollow) based on whether the delivery 
    was on weekend.
...
def plot_data(features, targets):
    ...
    ax.set_title('Processed Data for Training', fontdict=title_font)
